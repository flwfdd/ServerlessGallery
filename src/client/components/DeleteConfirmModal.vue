          ...
          <TransitionChild as="template" enter="ease-out duration-200"
            ...
            <DialogPanel
              ...
              <div class="text-center">
                <div
                  class="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-red-200 dark:bg-red-600/50 border-2 border-red-300 dark:border-red-500 mb-6 animate-bounce">
