            ...
            <DialogPanel
              ...
              <div v-if="file" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div v-if="file.title" class="md:col-span-2 space-y-2">
                    <label class="text-sm font-bold text-slate-800 dark:text-slate-200">{{
                      t('fileInfo.title')
                    }}</label>
                    <p class="text-slate-700 dark:text-slate-300 px-4 py-3">
                  ...
                  <div v-if="file.description" class="md:col-span-2 space-y-2">
                    <label class="text-sm font-bold text-slate-800 dark:text-slate-200">{{
                ...
                <div class="border-t-2 border-dashed border-slate-200 dark:border-slate-600 pt-8">
                  ...
                  <div class="space-y-4">
                    ...
                    <!-- 压缩版本 -->
                    <div v-if="file.mime_type.startsWith('image/')" class="space-y-4">
